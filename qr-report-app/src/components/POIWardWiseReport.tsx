...
const POIWardWiseReport: React.FC = () => {
    ...
    const filteredData = useMemo(() => {
        ...
        if (selectedWard !== 'All') {
            filtered = filtered.filter(item => item.wardName === selectedWard);
        }
        return filtered;
    }, [poiData, selectedZones, selectedWard, dateFrom, dateTo]);
    ...
    const handleSimulate70 = () => {
        if (isSimulated) {
            ...
            const isMatch = (item: POIRecord) => {
                ...
                const matchesWard = selectedWard === 'All' || item.wardName === selectedWard;
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 flex-1">
                        ...
                        <div className="relative group">
                            ...
                            <select
                                ...
                                className="w-full pl-10 pr-8 py-2.5 text-sm font-medium border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 bg-gray-50 hover:bg-white transition-all shadow-sm text-gray-700 appearance-none h-11 cursor-pointer"
                            >
                ...
                <div className="bg-white border-b border-gray-200 p-4 flex flex-col md:flex-row items-center justify-between gap-4 shrink-0">
                    ...
                    <div className="text-center flex-1">
                        ...
                        <div className="flex flex-wrap justify-center gap-2 mt-2 text-xs font-medium text-gray-600">
                            ...
                            {selectedWard !== 'All' && (
                                <span className="bg-gray-100 px-2 py-1 rounded">Ward: {selectedWard}</span>
                            )}
                            {/* Summary count */}
