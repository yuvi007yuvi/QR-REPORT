...
export const WhatsAppReport: React.FC = () => {
    ...
    const handleExportJPEG = async () => {
        ...
        const scrollContainer = document.getElementById('whatsapp-report-table-scroll-container');
                ...
                <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden" ref={tableRef}>
                    ...
                    <div className="p-4 bg-gray-50 border-t border-gray-200 text-center">
                        <p className="text-slate-500 font-medium text-xs tracking-wide">
                            Generated by <span className="font-extrabold text-indigo-600">Reports Buddy Pro</span> • Created by <span className="font-extrabold text-slate-700">Yuvraj Singh Tomar</span>
                        </p>
                    </div>
                </div>
